...
def generate_pdf(main_df, waste_df, purchase_df, cutting_df):
    ...
    # Logo
    pdf.image("/mnt/data/A_vector-style_digital_logo_design_for_NovaStruct,.png", x=10, y=8, w=30)
    pdf.set_font("Arial", 'B', 16)
    pdf.cell(0, 10, "NovaStruct Company", ln=True, align="C")
    pdf.ln(5)

    pdf.set_font("Arial", '', 10)
    pdf.cell(0, 8, f"Report Date: {datetime.date.today()}", ln=True)
    pdf.ln(5)
...
st.subheader("Created by NovaStruct Company")
